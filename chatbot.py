...
def main():
    ...
    parser.add_argument('--temperature', type=float, default=1.0,
                        help='sampling temperature(lower is more conservative, default is 1.0, which is neutral)')
    parser.add_argument('--relevance', type=float, default=-1.,
                        ...
                        'noticeably degrading coherence; set to <0 to disable relevance masking')
...
def beam_sample(net, sess, chars, vocab, max_length=200, prime='The ', beam_width=2, temperature=1.0):
    states = [initial_state(net, sess), initial_state(net, sess)]
    states = forward_text(net, sess, states, vocab, prime)
    computer_response_generator = beam_search_generator(sess, net, states, vocab[' '], None,
                                                        beam_width, forward_with_mask, (temperature, vocab['\n']))
...
def beam_search_generator(sess, net, initial_state, initial_sample, early_term_token, beam_width,
                          forward_model_fn, forward_args, temperature):
    """
